...
target("lua")
    ...
    -- Lua 核心源文件 (排除lua.c和luac.c，它们是解释器和编译器)
    add_files("3rdparty/lua/plainlua/*.c|lua.c|luac.c")

    -- 公开头文件目录
    add_includedirs("3rdparty/lua/plainlua", {public = true})
target_end()
...
target("axlua")
    ...
    add_includedirs(
        ...
        "extensions/scripting/lua-bindings/manual",
        "extensions/scripting/lua-bindings/auto",
        "extensions/cocostudio/src",
...
-- ========== 包含子项目 ==========
-- 参考 SakuraEngine 的模块化includes方式
includes("projects/SlotGame")
